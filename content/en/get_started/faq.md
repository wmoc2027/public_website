...
description: This page lists answers to frequently asked questions, categorized by topic. Please click on the item that interests you.
content_blocks:
  - _bookshop_name: hero
    heading:
      title: FAQ
      align: start
      content: Here are some frequently asked questions and their answers, sent to [contact@wmoc2027.jp](mailto:contact@wmoc2027.jp).
      width: 8
    background:
...
The participation fee can be selected by clicking the mark next to `card number`. By selecting `Discount Japanese citizens 1 -19,000 JPY`, the fee for Forest and Sprint participation will be 25,000 yen (excluding options). [See dtails here.]({{% relref "/get_started/entry#adding-options-including-discounts-for-japanese-citizens" %}})
  {{< /accordion-item >}}
